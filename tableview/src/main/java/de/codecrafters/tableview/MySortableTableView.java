 ...
 * @author ISchwarz
 */
public class MySortableTableView<T> extends MyTableView<T> {
     ...
     */
    public MySortableTableView(final Context context) {
        this(context, null);
    }
     ...
     */
    public MySortableTableView(final Context context, final AttributeSet attributes) {
     ...
     */
    public MySortableTableView(final Context context, final AttributeSet attributes, final int styleAttributes) {
     ...
     * @author ISchwarz
     */
    private class RecapSortingDataSetObserver extends RecyclerView.AdapterDataObserver {
